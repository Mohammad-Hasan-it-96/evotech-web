    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // Logical, RTL-aware sides (fade to avoid physical-direction slides).
          side === "end" &&
            "inset-y-0 end-0 h-full w-3/4 border-s data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:max-w-sm",
          side === "start" &&
            "inset-y-0 start-0 h-full w-3/4 border-e data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:max-w-sm",
          className
        )}
        {...props}
      >
